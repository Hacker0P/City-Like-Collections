      ...
      <div className="fixed inset-0 z-[90] flex justify-end">
        ...
        <div className="p-5 border-b border-slate-100 flex justify-between items-center bg-white z-10">
          <h2 className="text-xl font-bold flex items-center gap-2">
            ...
            {t('wishlist_title')} <span className="text-sm font-normal text-slate-500">({wishlist.length} {t('cart_items')})</span>
          </h2>
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-4">
          {wishlist.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center text-center p-8 opacity-60">
                ...
                <h3 className="text-lg font-bold text-slate-700">{t('wishlist_empty_title')}</h3>
                <p className="text-slate-500">{t('wishlist_empty_desc')}</p>
